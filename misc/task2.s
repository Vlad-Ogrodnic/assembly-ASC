...
opt: .long 8 
omie24: .long 1024
#totate varaibilele de aici pana la linia 16 au fost folosite in incercari pentru defrag, care nu au mers
omIe24: .long 1024
c2: .long 0
linieebx: .long 0
linieedx: .long 0
...
#ADD DEFRAG (incercare folosita in alta versiune de defrag pe care am incercat-o (nu a mers))
...
#(am incercat si cum e mai jos si prin a da delete si add la toate fisierele, cu conditia ca atunci cand dau add sa inceapa de la un anumit element, ca sa nu se strice ordinea (nu a mers))
et_defrag:
xorl %ecx, %ecx # ecx =i
